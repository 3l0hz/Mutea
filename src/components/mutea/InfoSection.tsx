        ...
        <div className="space-y-8 md:space-y-10">
          <div className="space-y-4 md:space-y-6 text-center md:text-left">
            <h2 className="text-3xl md:text-5xl font-display font-black uppercase tracking-tight">
              😣 Adiós a los <br className="md:hidden" /><span className="text-destructive">parlantes molestos</span>
            </h2>
            <p className="text-base md:text-lg text-foreground/60 leading-relaxed max-w-lg mx-auto md:mx-0 font-medium">
          ...
          <ul className="space-y-4 md:space-y-6 max-w-md mx-auto md:mx-0">
            {[
              "Afecta tu sueño",
              "Afecta tu salud",
              "Afecta tu productividad y a tu familia"
            ].map((item, idx) => (
              <li key={idx} className="flex items-center gap-4 text-[11px] md:text-sm font-display font-bold tracking-wider uppercase text-foreground/80">
        ...
        <div className="space-y-8 md:space-y-10">
          <div className="space-y-4 md:space-y-6 text-center md:text-left">
            <h3 className="text-3xl md:text-5xl font-display font-black uppercase tracking-tight">
              🔇 Tranquilidad, <br className="md:hidden" /><span className="text-primary">control y respeto</span>
            </h3>
            <p className="text-base md:text-lg text-foreground/60 leading-relaxed max-w-lg mx-auto md:mx-0 font-medium">
          ...
          <ul className="space-y-4 md:space-y-6 max-w-md mx-auto md:mx-0">
            {[
              "Ideal para casas y departamentos",
              "Pensado para quienes trabajan o tienen niños",
